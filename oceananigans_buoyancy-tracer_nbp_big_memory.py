...
if Nranks == 1 and not stokes:
    time, t_save, nx, hx, lx, x, y, z, xf, yf, zf, dx, visc = collect_time_outputs(fid, Nranks, stokes)
elif Nranks == 1 and stokes:
    time, t_save, nx, hx, lx, x, y, z, xf, yf, zf, dx, visc, u_f, u_s = collect_time_outputs(fid, Nranks, stokes)
